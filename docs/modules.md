...
* [selfcord package](selfcord.md)
    ...
    * [selfcord.bot module](selfcord.md#module-selfcord.bot)


        * [`Bot`](selfcord.md#selfcord.bot.Bot)


            * [`Bot.add_cmd()`](selfcord.md#selfcord.bot.Bot.add_cmd)


            * [`Bot.add_friend()`](selfcord.md#selfcord.bot.Bot.add_friend)


            * [`Bot.change_hypesquad()`](selfcord.md#selfcord.bot.Bot.change_hypesquad)


            * [`Bot.change_pfp()`](selfcord.md#selfcord.bot.Bot.change_pfp)


            * [`Bot.change_presence()`](selfcord.md#selfcord.bot.Bot.change_presence)


            * [`Bot.cmd()`](selfcord.md#selfcord.bot.Bot.cmd)
            ...
            * [`Bot.emit()`](selfcord.md#selfcord.bot.Bot.emit)


            * [`Bot.get_channel()`](selfcord.md#selfcord.bot.Bot.get_channel)


            * [`Bot.get_guild()`](selfcord.md#selfcord.bot.Bot.get_guild)


            * [`Bot.get_user()`](selfcord.md#selfcord.bot.Bot.get_user)


            * [`Bot.inbuilt_commands()`](selfcord.md#selfcord.bot.Bot.inbuilt_commands)


            * [`Bot.latency`](selfcord.md#selfcord.bot.Bot.latency)


            * [`Bot.load_extension()`](selfcord.md#selfcord.bot.Bot.load_extension)


            * [`Bot.on()`](selfcord.md#selfcord.bot.Bot.on)


            * [`Bot.process_commands()`](selfcord.md#selfcord.bot.Bot.process_commands)


            * [`Bot.redeem_nitro()`](selfcord.md#selfcord.bot.Bot.redeem_nitro)


            * [`Bot.run()`](selfcord.md#selfcord.bot.Bot.run)


    * [Module contents](selfcord.md#module-selfcord)
